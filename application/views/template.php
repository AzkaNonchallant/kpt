...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url('assets/images/kapsul.jpg') ?>" type="image/x-icon">
    <!-- fontawesome icon -->
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/plugins/bs-datetimepicker/css/bootstrap-datetimepicker.min.css">
        <link rel="stylesheet" href="<?= base_url() ?>assets/plugins/jQuery-3.6.0/jquery-3.6.0.min.js">
        <link rel="stylesheet" href="<?= base_url() ?>assets/plugins/jQuery-3.6.0/jquery-3.6.0.min.js">
        <link rel="stylesheet" href="<?= base_url() ?>assets/plugins/jquery/js/jquery.min.js">
...
<body style="background-color: #F0F8FF;">
    ...
    <script src="<?= base_url() ?>assets/plugins/jQuery-3.6.0/jquery-3.6.0.min.js"></script>
    <?= $contents ?>
