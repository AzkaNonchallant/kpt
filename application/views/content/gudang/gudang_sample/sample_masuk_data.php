...
<body>
  ...
  $(document).ready(function() {
    $('#export').click(function() {
      ...
      if (filter_tgl == '') {
        window.location = "<?= base_url() ?>gudang/gudang_sample/sample_masuk/pdf_surat";
      } else {
        var url = "<?= base_url() ?>gudang/gudang_sample/sample_masuk/pdf_surat" + filter_tgl.split("/")[2] + "-" + filter_tgl.split("/")[1] + "-" + filter_tgl.split("/")[0];
        window.open(url, 'gudang/gudang_sample/sample_masuk/', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes');
      }
    })
