                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group" role="group"
                                                                        ...
                                                                        <?php if ($level === "0" && $k['status_po_import'] == 'proses'): ?>
                                                                            <button type="button"
                                                                                class="btn btn-warning btn-square btn-sm text-light"
                                                                                ...
                                                                                data-harga_perunit="<?= number_format($k['harga_perunit'], 0, ",", ".") ?>"
                                                                                data-prc_admin="<?= $k['prc_admin'] ?>"
                                                                                data-kode_tf_in="<?= $k['kode_tf_in'] ?>" <i
                                                                                class="feather icon-edit-2"></i>Proses
                                                                            </button>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="p-mesh" name="mesh" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="p-kode_tf_in" name="kode_tf_in"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Kurs PIB</label>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#proses').on('show.bs.modal', function (event) {
                ...
                modal.find('#p-kode_tf_in_2').val(kode_tf_in);
