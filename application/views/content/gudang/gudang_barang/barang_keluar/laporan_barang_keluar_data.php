                                              ...
                                              <div class="input-group">
                                                    ...
                                                    <select class="form-control chosen-select" id="filter_batch" name="filter_batch">
                                                      <option value="" disabled selected hidden>- Batch -</option>
                                                        ...
                                                        <input type="text" id="filter_tgl" value="<?= $tgl == null ? '' : $tgl ?>" class="form-control datepicker" placeholder="Fiter Tanggal Disini" aria-label="Recipient's username" aria-describedby="basic-addon2" autocomplete="off">
                                                        ...
                                                        <div class="input-group-append">
                                                            ...
                                                            <a href="<?=base_url()?>gudang/gudang_barang/barang_laporan_barang_keluar" style="width: 40px;" class="btn btn-warning" id="refresh" type="button"><i class="feather icon-refresh-ccw"></i></a>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
                                                           ...
                                                           <td style="text-align: right;"><?=isset($k['qty']) ? number_format($k['qty'],0,",",".") : 0?><?=$k['satuan']?></td>
                                                            <td class="text-right">
                                                              <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a  
                                                                 href="<?=base_url()?>gudang/gudang_barang/barang_keluar/laporan_barang_keluar<?=isset($k['id_barang_masuk']) ? $k['id_barang_masuk'] : ''?>" 
  ...
  $(document).ready(function() {
    $('#lihat').click(function () {
      ...
      if (filter_tgl =='' && filter_tgl2 !='') {
        ...
        window.location = "<?=base_url() ?>Laporan_barang_keluar/index?"+ query.toString()
    ...
    $('#export').click(function () {
     ...
     if (filter_tgl =='' && filter_tgl2 !='') {
        ...
        var url = "<?=base_url()?>laporan_barang_keluar/pdf_laporan_barang_keluar?" + query.toString();
...
$(document).ready(function() {
  ...
  $(this).find('#v-note').val(note)
    jQuery.ajax({
        url: "<?=base_url()?>gudang/barang_keluar/laporan_barang_keluar_data",
        dataType:'json',
        type: "post",
