                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="jumlah_zak" name="jumlah_zak" placeholder="Jumlah (Zak)" autocomplete="off" style="text-transform:uppercase" onkeyup="this.value = this.value.toUpperCase()" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="harga_po_pembelian" name="harga_po_pembelian" placeholder="Harga (Rp/Kg)" autocomplete="off" style="text-transform:uppercase" onkeyup="this.value = this.value.toUpperCase()" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="ket_po" name="ket_po" placeholder="Keterangan" required></textarea>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Jumlah (Zak)</label>
                                <input type="text" class="form-control" id="v-jumlah_zak" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                function hitungTotal() {
                    let jumlahKg = unformatRupiah($('#jumlah_po_pembelian').val());
                    let hargaPerKg = unformatRupiah($('#harga_po_pembelian').val());
                    let total = jumlahKg * hargaPerKg;
                    $('#total_harga').val(formatRupiah(total));
                }

                // === Ketika jumlah zak diubah, otomatis ubah kg dan total ===
                ...
                // === Ketika harga diubah, langsung hitung total ===
                $('#harga_po_pembelian').on('input', function() {
                    let value = this.value.replace(/\D/g, '');
                    this.value = new Intl.NumberFormat('id-ID').format(value);
                    hitungTotal();
                });

                // === Format realtime input angka ===
                $('#jumlah_zak').on('keyup', function() {
                    let value = this.value.replace(/\D/g, '');
                    this.value = new Intl.NumberFormat('id-ID').format(value);
                });

                // === Auto isi mesh, bloom, supplier saat pilih barang ===
                $('#id_barang').on('change', function() {
                    let opt = $(this).find(':selected');
                    $('#mesh').val(opt.data('mesh') || '');
                    $('#bloom').val(opt.data('bloom') || '');
                    $('#nama_supplier').val(opt.data('nama_supplier') || '');
                });

                // === Reset semua nilai setiap modal dibuka ===
                $('#add').on('show.bs.modal', function() {
                    ...
                    jQuery.ajax({
                        ...
                        type: "post",
                        data: {
                            no_po_pembelian: no_po_pembelian
                        },
            ...
            $('#detail').on('show.bs.modal', function(event) {
                ...
                $(this).find('#v-jumlah_zak').val(formatRupiah(zak.toString()))
