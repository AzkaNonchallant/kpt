    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td><?= $k['kode_barang'] ?></td>
          <td><?= $k['nama_barang'] ?></td>
          <td style="text-align: right;"><?= number_format($k['stok'] ?? 0, 0, ",", ".") ?>&nbsp;<?= $k['satuan'] ?></td>
          <td style="text-align: right;"><?= number_format($k['masuk'] ?? 0, 0, ",", ".") ?>&nbsp;<?= $k['satuan'] ?></td>
          <td style="text-align: right;"><?= number_format($k['keluar'] ?? 0, 0, ",", ".") ?>&nbsp;<?= $k['satuan'] ?></td>
          <td style="text-align: right;"><?= number_format(($aktual ?? 0), 0, ",", ".") ?>&nbsp;<?= $k['satuan'] ?></td>
