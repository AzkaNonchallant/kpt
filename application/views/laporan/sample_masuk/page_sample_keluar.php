...
<head>
  <meta charset="utf-8">
  <title>Laporan Sample Keluar</title>
  <style>
    @page {
      size: A4 landscape;
      margin: 15mm 10mm;
...
<body>
  ...
  <table class="info-table">
    <tr>
      ...
      <td style="width:2%;">:</td>
      <td style="width:33%;"><?= $row['kode_sample_out'] ?? '-' ?></td>
  ...
  <table class="main">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center"><?= number_format($d['jumlah_keluar'], 3) ?> <?= $d['satuan'] ?? 'Unit' ?></td>
        <td class="text-center"><?= $d['no_batch'] ?></td>
        <td class="text-center"><?= $d['kode_sample_out'] ?></td>
      ...
      <tr style="font-weight:bold;">
        <td colspan="2" class="text-right">Total Sample Keluar</td>
  ...
  <div class="footer">
    ...
    <p class="note"><i>Catatan: Laporan sample keluar ini dibuat otomatis oleh sistem</i></p>
  </div>
</body>
</html>
