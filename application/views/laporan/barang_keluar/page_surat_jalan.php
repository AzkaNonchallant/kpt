                              ...
                              <td class="text-right">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                  ...
                                  <a
                                    ...
                                    onclick="window.open(<?= base_url()?>gudang/gudang_barang/barang_keluar/barang_keluar/pdf_surat_jalan/<?= str_replace('/', '--', $k['kode_tf_out']) ?>, 'pdf_laporan_barang_stok', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); ">
                                    <i class="feather icon-file"></i>Surat Jalan
                                  </a>
                                  <a
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-4">
            <label>Kode TF Out</label>
            <input type="text" class="form-control" id="e-kode_tf_out" readonly>
          </div>

          <div class="col-md-4">
            <label>No Surat Jalan</label>
            <input type="text" class="form-control" id="e-no_surat_jalan" readonly>
          </div>

          <div class="col-md-4">
            <label>Nama Customer</label>
            <input type="text" class="form-control" id="e-nama_customer" readonly>
          </div>

          <div class="col-md-4">
            <label>Nama Barang</label>
            <input type="text" class="form-control" id="e-nama_barang" readonly>
          </div>

          <div class="col-md-4">
            <label>Mesh</label>
            <input type="text" class="form-control" id="e-mesh" readonly>
          </div>

          <div class="col-md-4">
            <label>Bloom</label>
            <input type="text" class="form-control" id="e-bloom" readonly>
          </div>

          <div class="col-md-4">
            <label>Jumlah Kirim (Kg)</label>
            <input type="text" class="form-control" id="e-jumlah_kirim" readonly>
          </div>

          <div class="col-md-4">
            <label>Tanggal Kirim</label>
            <input type="text" class="form-control" id="e-tgl_kirim" readonly>
          </div>

          <div class="col-md-4">
            <label>Note Untuk Gudang</label>
            <textarea class="form-control" id="e-note_gudang" rows="3" readonly></textarea>
          </div>

          <div class="col-md-4">
            <label>Gudang Admin</label>
            <input type="text" class="form-control" id="e-gdg_admin" readonly>
          </div>
        </div>
      </div>
