...
<body>
  <?php 
  if ($tgl == null & $tgl2 == null & $batch == null) {
    $per = "";
  } else if ($batch == null){
    ...
    $per = "No Batch : ".$batch. "<br><br><br><br><br><br><br><br><br><br><br>Periode : ".$tgl." - ".$tgl2;
  }
...
?>
                                                  ...
                                                  <table style="width: 1000px;<?=$d?>">
                                                            ...
                                                            <!-- <td style="padding: 0;">
                                                              ...
                                                              <table style="margin: -1px;">
                                                                ...
                                                                <tbody >
                                                                  ...
                                                                  ?>
                                                                    <tr>
                                                                      <td><?=$ddd['kode_tf_in']?></td>
                                                                      <td><?=$ddd['nama_barang']?></td>
                                                                      <td><?=$ddd['nama_supplier']?></td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                          <th colspan="7" class="center">Jumlah</th><th style="text-align: right;"><?=number_format($jml,0,",",".")?>&nbsp;<?=$k['satuan']?></th>
                                                        </tr>
                                                    </tfoot>
                                                </table>
  <?php      
