    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="center"><?= $d['no_surat_jalan'] ?></td>
          <td class="center">
  ...
  <div class="footer">
    <table class="tab-footer" width="100%" style="border: none;">
      <tr>
        ...
        <td width="50%" style="text-align:left; vertical-align: top;">
          <p style="margin-left: 400px;">Barang diterima dalam kondisi baik tanggal...... oleh :</p>
          <div class="signature-space"></div>
