...
class Barang_stok extends MY_Controller {
	...
	public function index()
	{
		...
		$data['result'] = $this->M_barang_masuk->get3()->result_array();
        ...
        $this->template->load('template', 'content/gudang/gudang_barang/barang_stok/barang_stok_data',$data);
        // print_r($data);
