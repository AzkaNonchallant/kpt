...
class sample_keluar extends MY_Controller {
    ...
    public function index()
    {
        ...
        $data['result'] = $this->M_sample_keluar->get($tgl, $tgl2, $nama_customer, $no_sppb)->result_array();
        // $data['res_gud'] = $this->M_sample_masuk->get()->result_array();
        $data['po_sample'] = $this->M_sample_keluar->get()->result_array();
    ...
    public function data_sample_keluar(){
