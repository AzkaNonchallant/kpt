...
class Laporan_barang_stok_2 extends MY_Controller {
	...
	function __construct()
    {
        ...
        $this->load->model('M_laporan_barang_stok');
	...
	public function index($tgl=null)
	{
        ...
        $data['res_batch'] = $this->M_barang->get2()->result_array();
        ...
        $data['tgl'] = $tgl;
		$this->template->load('template', 'content/barang/laporan_barang_stok_2',$data);
        // print_r($data);
	...
	public function pdf_laporan_barang_stok($tgl=null)
    {
        ...
        $data['tgl'] = $tgl==null?date("Y-m-d"):$tgl;
    ...
    public function data_barang_stok(){
        $id_barang = $this->input->post('id_barang',TRUE);

        $result = $this->M_laporan_barang_stok_2->data_barang_stok($id_barang)->result_array();
