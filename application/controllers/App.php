...
class App extends MY_Controller {
	...
	{	
		...
		$tot_surat_jalan = $this->M_dashboard->tot_surat_jalan($hariini)->row_array();
		$data['tot_surat_jalan'] = $tot_surat_jalan['tot_surat_jalan'];
		...
		$tot_customer = $this->M_dashboard->tot_customer()->row_array();
		$data['tot_customer'] = $tot_customer['tot_customer'];
